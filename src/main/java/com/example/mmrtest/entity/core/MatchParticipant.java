...
public class MatchParticipant {
    ...
    public Integer getTotalCs() { return totalCs; }
    public void setTotalCs(Integer totalCs) { this.totalCs = totalCs; }
    public Integer getGoldEarned() { return goldEarned; }
    public void setGoldEarned(Integer goldEarned) { this.goldEarned = goldEarned; }
    public Integer getDamageToChampions() { return damageToChampions; }
    public void setDamageToChampions(Integer damageToChampions) { this.damageToChampions = damageToChampions; }
    ...
    public Integer getWardsKilled() { return wardsKilled; }
    public void setWardsKilled(Integer wardsKilled) { this.wardsKilled = wardsKilled; }
    public Integer getControlWardsPlaced() { return controlWardsPlaced; }
    public void setControlWardsPlaced(Integer controlWardsPlaced) { this.controlWardsPlaced = controlWardsPlaced; }
    public Integer getTotalTimeSpentDead() { return totalTimeSpentDead; }
    public void setTotalTimeSpentDead(Integer totalTimeSpentDead) { this.totalTimeSpentDead = totalTimeSpentDead; }
